...
<body>
    <div class="box1">
        ...
        <div class="xyz">
            <form method="post"> <!-- Add the "method" attribute to the form -->
                ...
                <input type="text" name="license_number" class="b12" placeholder="Company License Number"><br><br>
                <input type="text" name="number_of_ship" class="c13" placeholder="Number of Ship"><br><br>
                <textarea name="details" class="d14" placeholder="Details"></textarea><br><br>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO comdetails (companyname, license_number, number_of_ship, details)
                VALUES ('$companyname', '$license_number', '$number_of_ship', '$details')";
        if (mysqli_query($conn, $sql) === TRUE) {
            echo "DATA INSERTED";
        } else {
            echo "Data not Inserted: " . mysqli_error($conn);
        }
        // header('location:./appliedcompanylist.php');
    }
    ?>
</body>
